...
def generate_dp_matrix(tf_terms, tf_phrases, doc_ids, method="indirect"):
    ...
    ----------
    tf_terms: dict
        A dictionary containing TF information of terms (including model and transformation)
    tf_phrases: dict
        A dictionary containing TF information of phrases (including model and transformation)
    doc_ids: array_like    
    ...
    # Preparing data
    model_dict = {
        'tft_model': tf_terms['model'],  # Assuming this is TfidfVectorizer
